...
public static class ECSManager
{
    ...
    //Los flags se usan como respuesta despues de ejecutar los SYSTEMS. Se procesan las respuestas y se QUITA el flag despues.
    enum Flags { 
        Flag0,
        Flag1,
        Flag2,
    ...
    public static void AddFlag<Flags>(ECSEntity entity, Flags flagID)
    { 
